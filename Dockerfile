...
# SHA-256 checksums computed from the official GitHub release assets (llvmorg-18.1.8).
# No pre-computed checksum file is published by LLVM for these binaries; hashes were
# generated by downloading the tarballs directly and running sha256sum.
RUN ARCH=$(uname -m) && \
    if [ "$ARCH" = "x86_64" ]; then \
